...
QT_MOC_LITERAL(1, 4, 11), // "stock_added"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 21), // "on_buttonBox_accepted"
QT_MOC_LITERAL(4, 39, 14), // "checkLineEdits"
QT_MOC_LITERAL(5, 54, 21) // "on_buttonBox_rejected"

    },
    "add\0stock_added\0\0on_buttonBox_accepted\0"
    "checkLineEdits\0on_buttonBox_rejected"
};
...
void add::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (add::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&add::stock_added)) {
                *result = 0;
                return;
            }
        }
